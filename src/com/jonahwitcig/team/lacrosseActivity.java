...
public class lacrosseActivity extends Activity {
    /** Called when the activity is first created. */
    
	TextView team1, team2, tvWhosAP;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lacrosse);
        ...
        tvWhosAP = (TextView) findViewById(R.id.whosAP);
        ...
        int whosAP = myRandom.nextInt(2);
        if (whosAP == 1)
        	tvWhosAP.setText("Team 1 has AP");
        else
        	tvWhosAP.setText("Team 2 has AP");
