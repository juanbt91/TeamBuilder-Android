...
public class footballActivity extends Activity {
	...
	TextView team1, team2, tvWhosKick;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        tvWhosKick = (TextView) this.findViewById(R.id.whosKick);
        ...
        int whosKick = myRandom.nextInt(2);
        if (whosKick == 1)
        	tvWhosKick.setText("Team 1 kicks off");
        else
        	tvWhosKick.setText("Team 2 kicks off");
        }
