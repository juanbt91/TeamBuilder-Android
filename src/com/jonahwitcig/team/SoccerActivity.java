...
public class SoccerActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String customSportName = settings.getString("customSportName", "");
        String customRAV = settings.getString("customRAV", "");
        ...
        if (customSportName != "")
        {
        	setTitle("Team Builder - Sports - " + customSportName);
        	if (whosBallChoice == 0)
        		whosBall.setText("Team 1 " + customRAV);
        	else
        		whosBall.setText("Team 2 " + customRAV);
        }
        else
        {
        	setTitle("Team Builder - Sport - Soccer");
        	if (whosBallChoice == 0)
        		whosBall.setText("Team 1 gets ball first");
        	else
        		whosBall.setText("Team 2 gets ball first");
        }
        
        customSportName = "";
        customRAV = "";
        prefEditor.remove("customSportName");
        prefEditor.remove("customRAV");
        prefEditor.commit();
